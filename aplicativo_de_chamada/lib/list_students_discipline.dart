...
class ListStudentsForEachDiscipline
  ...
  Future<void> fetchDataFromAPI() async {
    final response = await http.post(
        Uri.parse('http://https://chamada-backend-develop.onrender.com/retorna_materias_professor'),
  ...
  Future<void> fetchStudentsFromDiscipline(String disciplineForCheckStudents) async {
    final response = await http.post(
        Uri.parse('http://https://chamada-backend-develop.onrender.com/return_alunos_materias'),
